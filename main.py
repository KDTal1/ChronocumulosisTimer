...
complete_btn = Button(controls_frame, text='Mark as Complete', width=14, command=lambda: mainProcess.complete_task(tasks_listbox, timer_label, tasks))
